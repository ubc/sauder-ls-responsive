...
<?php responsive_header(); // before header hook ?>
	<div id="header">
		...
		<?php $banner_image = responsive_sauder_get_banner_image( get_theme_mod('banner_image', '') ); ?>

		<?php if( $banner_image != '' ) : ?>

			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/<?php echo $banner_image; ?>"></img>
